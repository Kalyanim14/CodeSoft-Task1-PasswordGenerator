...
entry_name = tk.Entry(frame, font=("Arial", 12), width=40, bg="#ffe4e1")  # Very light pink color
entry_name.grid(row=0, column=1, padx=5, pady=5)

# Phone Entry
label_phone = tk.Label(frame, text="Phone:", font=("Arial", 12), bg="AliceBlue")
label_phone.grid(row=1, column=0, padx=5, pady=5)
entry_phone = tk.Entry(frame, font=("Arial", 12), width=40, bg="#ffe4e1")  # Very light pink color
...
entry_email = tk.Entry(frame, font=("Arial", 12), width=40, bg="#ffe4e1")  # Very light pink color
...
entry_address = tk.Entry(frame, font=("Arial", 12), width=40, bg="#ffe4e1")  # Very light pink color
...
entry_search = tk.Entry(search_frame, font=("Arial", 12), width=40, bg="#ffe4e1")  # Very light pink color
